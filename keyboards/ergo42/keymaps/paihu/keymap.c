...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |      |      |   !  |   "  |   #  |   $  |   %  |   |   &  |   '  |   (  |   )  |      |   =  |      |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |      |      | XXXX | XXXX | XXXX | XXXX | XXXX |   | left |  up  | down | right|   |  |   _  |      |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |      |      | XXXX | XXXX | XXXX |  {   |   (  |   |  )   |  }   | XXXX | XXXX | XXXX | PgUp |      |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |   |      |      |      |      | Home | PgDn | End  |
   * `------------------------------------------------'   `------------------------------------------------'
   */ 
  [_LOWER] = LAYOUT( \
    ...
    _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, KC_LEFT, KC_DOWN,    KC_UP,   KC_RGHT, JP_PIPE, JP_UNDS, _______, \
    _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, S(JP_LBRC), JP_LPRN, JP_RPRN, S(JP_RBRC), XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, _______, \
